...
public class DbMappersSchemaXmlBuilder
{
    ...
    public void Test()
    {
        var mappers =
            new SchemaMappers
            {
                ...
                CodeGeneration =
                    ...
                    {
                        MappersCommonNamespaceName = "ShtrihM.Wattle3.Examples.DomainObjects.Examples.Generated.Common",
                        MappersIntefacesNamespaceName = "ShtrihM.Wattle3.Examples.DomainObjects.Examples.Generated.Interface",
                        MappersImplementsNamespaceName = "ShtrihM.Wattle3.Examples.DomainObjects.Examples.Generated.Implements",
                        MappersTestsNamespaceName = "ShtrihM.Wattle3.Examples.DomainObjects.Examples.Generated.Tests",
        ...
        var fileName = Path.Combine(ProviderProjectBasePath.ProjectPath, @"DomainObjects\Examples\DbMappers.Schema.xml");
