...
- [**Автогенерация мапперов** на чистом ADO.NET для PostgreSQL и SQL Server](#автогенерация-мапперов-на-чистом-adonet)
    ...
    - [Основные возможности кодогенерированных мапперов](#основные-возможности-кодогенерированных-мапперов)
        - [**Генерация уникального** и персистентного в БД значения **первичного ключа** с минимальным обращением к БД](#генерация-уникального-и-персистентного-в-бд-значения-первичного-ключа-с-минимальным-обращением-к-бд)
...
---
#### Генерация уникального и персистентного в БД значения первичного ключа с минимальным обращением к БД
