...
- Ключи и данные в оперативной памяти занимают места *O(_Число ключей * (8 + размер ключа + размер данных в байтах)_)* и не расходуют память на служебюную информацию CLR.
