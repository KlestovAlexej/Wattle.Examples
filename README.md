...
```
<br>**Среднее время поиска данных по ключу : 22,36 микросекунды**
<br>
...
Предварительно в БД создано *300.000.000* ключей, а на дисковой системе создан файловый кэш ключей из БД.
