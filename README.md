...
- [**Идемпотентность**](#идемпотентность)
    - [Пример старта реестра на *10.000.000* ключей](#пример-старта-реестра-на-10000000-ключей)
...
### Пример старта реестра на **10.000.000** ключей
...
```
Время создания и 100% инициализации реестра : 00:00:01.5402947
Занято памяти : 240 056 920 байт
