...
- Ключи и данные в оперативной памяти занимают места *O(_Число ключей * (sizeof(long) + размер ключа + размер данных)_)* и не расходуют память на служебюную информацию CLR.
