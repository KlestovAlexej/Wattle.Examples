...
- [**Идемпотентность**](#идемпотентность)
    - [Пример старта реестра на *100.000.000* уникальных ключей *(2.2 секунды)*](#пример-старта-реестра-на-100000000-уникальных-ключей-22-секунды)
...
### Пример старта реестра на **100.000.000** уникальных ключей *(2.2 секунды)*
...
```
Старт рееста на '100 000 000' ключах в БД и файловом кэше.

Время создания и 100% инициализации реестра : 00:00:02.2036206
Занято памяти : 2 400 070 224 байт
Время поиска всех ключей : 00:28:33.9758167
Количество созданных Unit of Works : 300 000 000
Количество реальных подключений к БД : 0
...
<br>На подготовку окружения ушло времени '02:46:13'.
