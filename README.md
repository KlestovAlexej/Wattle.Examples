...
- [**Идемпотентность**](#идемпотентность)
    - [Пример старта реестра на **1.000.000.000** уникальных ключей **(24.8 секунд)**](#пример-старта-реестра-на-1000000000-уникальных-ключей-248-секунд)
...
Все примеры оформлены как [NUnit](https://nunit.org/)-тесты для запуска в ОС Windows из-под [Visual Studio 2022](https://visualstudio.microsoft.com/ru/vs/) (версии не ниже 17.8).
...
### Пример старта реестра на **1.000.000.000** уникальных ключей *(24.8 секунд)*
...
```
Текущее время тестов : 15.03.2023 1:00:00
...
Время создания ключей : 02:20:28.9608763
Всего ключей          : 1 000 000 000

Всего занято памяти тестом : 24 006 518 448 байт
Занято памяти реестром     : 24 000 455 136 байт
...
gkeys_TransactionKeys_113.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_116.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_119.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_122.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_125.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_128.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_131.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_134.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_137.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_140.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_143.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_146.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_149.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_152.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_155.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_158.gkeys - размер 1 200 001 958
gkeys_TransactionKeys_161.gkeys - размер 1 200 001 958

----------------------------------------------------------------------
Старт реестра на '1 000 000 000' ключах в БД и файловом кэше.
Время создания и инициализации реестра : 00:00:24.8810478

Время поиска всех ключей                 : 05:15:13.4742265
Среднее время поиска ключа (микросекунд) : 18,9134742265
Всего занято памяти тестом : 24 006 891 592 байт
Занято памяти реестром     : 24 000 436 816 байт
...
----------------------------------------------------------------------
Полное время теста : 07:36:07.9501113
```
