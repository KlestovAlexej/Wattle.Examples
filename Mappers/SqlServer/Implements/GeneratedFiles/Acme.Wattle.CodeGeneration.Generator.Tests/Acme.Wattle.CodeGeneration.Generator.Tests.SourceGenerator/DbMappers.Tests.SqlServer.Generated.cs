...
*
* Генератор - Acme.Wattle.CodeGeneration.Generators.Mappers.SqlServerMappersTestsCodeGenerator
*
*/
...
using __Mappers = Acme.Wattle.Examples.Mappers.SqlServer.Implements.Generated.SqlServer.Implements.Mappers;
