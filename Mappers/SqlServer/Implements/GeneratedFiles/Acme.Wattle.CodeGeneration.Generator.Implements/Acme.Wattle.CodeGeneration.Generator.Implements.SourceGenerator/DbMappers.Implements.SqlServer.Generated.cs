...
* Реализации мапперов.
*
* Генератор - Acme.Wattle.CodeGeneration.Generators.Mappers.SqlServerMappersImplementsCodeGenerator
*/
...
using Acme.Wattle.Mappers.SqlServer.Schema;
...
using Constants = Acme.Wattle.Mappers.Constants;
...
FROM [Object_A]";
                    ...
                    ExpandCommand(
                        ...
                        null,
                        null,
                        selectFilter as ISqlServerMapperSelectFilter);
                }
                catch (Exception exception)
                {
